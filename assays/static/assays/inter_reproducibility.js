...
$(document).ready(function() {
    ...
    // TODO TODO TODO
    // window.GROUPING.refresh_function = window.INTER_REPRO.show_repro;
    ...
    window.INTER_REPRO.show_repro = function() {
        ...
        if (first_run && $.urlParam('p')) {
            var data = {
                ...
                call: window.INTER_REPRO.call,
                intention: 'charting',
                study_set_id: window.INTER_REPRO.study_set_id,
        ...
        if (window.INTER_REPRO.call === 'fetch_data_points_from_filters') {
